...
describe('BoardManager', function(){
	...
	describe("#movements", function(){
		...
		it("find location dice rolls away", function(){
			const expected1 = { "next": "go", "gain": 0, "upper": false, "visit": []}
			assert.deepEqual(board1.moveLocation(player, 0), expected1) // no movement

			board1.moveLocation(player, 3); // ...baltic

			const expected2 = { "next": "oriental ave", "gain": 0, "upper": false, "visit": ["income tax", "reading railroad", "oriental ave"]}
			...
			const expected3 = { "next": "pennsylvania railroad", "gain": 0, "upper": false, "visit": ["pennsylvania railroad", "fifth ave"]}
			...
			const expected4 = { "next": "mediterranean", "gain": 1, "upper": false, "visit": ["boardwalk", "go", "mediterranean ave"]}
	...
	*/
		...
		it("find next location if travelling odd and forward", function(){
		...
		it("find next location if travelling odd and backward", function(){
		...
		it("find next location if travelling even and forward", function(){
			const expected1 = { "next": "mediterranean ave", "track": 1 };
		...
		it("find next location if travelling even and backward", function(){
			const expected1 = { "next": "boardwalk", "track": 1 };
		...
		it("find info about location jumped to", function(){
			const expected1 = { "next": "boardwalk", "gain": 0, "upper": false, "visit": ["boardwalk"]}
			assert.deepEqual(board1.jumpToLocation("boardwalk"), expected1) // jump to property

			const expected2 = { "next": "go", "gain": 200, "upper": false, "visit": ["go"]}
			assert.deepEqual(board1.jumpToLocation("go"), expected2) // jump to collectGroup

			const expected3 = { "next": "holland tunnel sw", "gain": 0, "upper": false, "visit": ["holland tunnel sw"]}
		...
		it("find info about location advancement", function(){
			...
			const expected2 = { "next": "oriental ave", "gain": 0, "upper": false, "visit": ["reading railroad", "oriental ave"]}
			...
			const expected3 = { "next": "fifth ave", "gain": 0, "upper": false, "visit": ["pennsylvania railroad", "fifth ave"]}
			...
			const expected4 = { "next": "mediterranean ave", "gain": 200, "upper": false, "visit": ["go", "mediterranean ave"]}
			assert.deepEqual(board1.advanceToLocation(player2, "mediterranean ave"), expected4) // pass collect

			board1.advanceToLocation(player2, "boardwalk")

			const expected5 = { "next": "go", "gain": 200, "upper": false, "visit": ["go"]}
			...
			const expected6 = { "next": "miami ave", "gain": 0, "upper": false, "visit": ["holland tunnel ne", "miami ave"]}
			assert.deepEqual(board1.advanceToLocation(player2, "miami ave"), expected6) // pass teleport

			board1.advanceToLocation(player2, "florida ave")

			const expected7 = { "next": "holland tunnel sw", "gain": 0, "upper": false, "visit": ["holland tunnel ne", "holland tunnel sw"]}
